...
/**
 * Game worker for "enchantment" spell.
 */
@Injectable() // Injectable required here for dependency injection
export class SpellEnchantmentGameWorker implements IGameWorker, IHasGameHookService {

  public gameHookService: GameHookService;

  readonly type: string = 'spell-enchantment';
  ...
  public async create(gameInstance: IGameInstance, data: {user: number}): Promise<IGameAction<IInteractionPutCardOnBoard>> {
    return {
      ...
      name: {
        en: `Play Enchantment`,
        fr: `Jouer un Enchantement`,
      },
      description: {
        en: `Play Enchantment on an artifact`,
        fr: `Jouer un Enchantement sur un artefact`,
      },
  ...
  public async execute(gameInstance: IGameInstance, gameAction: IGameAction<IInteractionPutCardOnBoard>): Promise<boolean> {
    ...
    cardChanged.currentStats.capacities = ['grow', 'run'];
    cardChanged.currentStats.top.capacity = undefined;
    cardChanged.currentStats.right.capacity = undefined;
    cardChanged.currentStats.bottom.capacity = undefined;
    cardChanged.currentStats.left.capacity = undefined;
    ...
    this.arenaRoomsService.sendMessageForGame(
      gameInstance,
      {
        fr: `A joué un Enchantement`,
        en: `Played Enchantment`,
      },
      gameAction.user);
